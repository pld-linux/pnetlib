...
BuildRequires:	pnet-compiler-csharp >= 0.5.10
BuildRequires:	pnet-tools
Requires:	csunit
Requires:	pnet-interpreter
Requires:	pnet-jscript
Requires:	pnetlib-base
Requires:	pnetlib-compat
Requires:	pnetlib-irda
Requires:	pnetlib-openssl
Requires:	pnetlib-visualbasic
Requires:	pnetlib-winforms
Requires:	pnetlib-xsharp
...
W tym pakiecie znajduj± siê podstawowe pliki dla pnetlib. Potrzebujesz je je¿eli chcesz cokolwiek z pnetlib. Dla programów wykorzystaj±cych tylko standardowe biblioteki jest to wszystko czego potrzebujesz.
...
Nak³adki na ró¿ne biblioteki X11: X11, Xext i imlib. Zainstaluj je¿eli chcesz tworzyæ aplikacje lub uruchamiaæ programy Portable .NEt korzystaj±ce bezpo¶rednio z biblotek X11.

Biblioteka zosta³a napisana jako tortura dla mechanizmu wywo³añ bezpo¶rednich "pinvoke" Portable .NET. Kod ¼ród³owy mo¿e byæ przydatny je¿eli jeste¶ zainteresowany korzystaniem z PInvoke.
...
siê dodaæ obs³ugê innego engine SSL do pnetlib, preferowany jest GNU TLS.
...
System.Drawing.Xsharp, a backend that connects it to XSharp.  XSharp
is in package pnetlib-xsharp.
...
A unit testing driver program based on JUnit.  Install this if you
wish to run the test suites that come with Portable .NET programs, or
write your own.
